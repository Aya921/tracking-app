...
void main() {
  ...
  late StartOrderResponseEntity responseEntity;
  ...
  setUpAll(() {
    ...
    responseEntity = StartOrderResponseEntity(
      id: '',
      user: '',
      orderItems: [],
      totalPrice: 12,
  ...
  group("test home viewModel ", () {
    ...
    group("test _startOrder function", () {
      blocTest<HomeViewModel, HomeStates>(
        ...
        build: () {
          ...
          final mockResult = SucessResult<StartOrderResponseEntity>(
            responseEntity,
          );
          provideDummy<Result<StartOrderResponseEntity>>(mockResult);

          when(
            mockUpdateOrderStateUseCase.startOrder(orderId),
          ).thenAnswer((_) async => mockResult);
      ...
      blocTest<HomeViewModel, HomeStates>(
        ...
        build: () {
          ...
          final mockResult = FailedResult<StartOrderResponseEntity>(
            "errorMessage",
          );
          provideDummy<Result<StartOrderResponseEntity>>(mockResult);
    ...
    group("test _deleteOrderLocaly function", () {
      ...
      blocTest<HomeViewModel, HomeStates>(
        ...
        act: (bloc) => bloc.add(DeleteOrderLocalyEvent(orderId)),
        expect: () => const [
          HomeStates(isLoading: false, errorMessage: "error", orders: null),
        ],
    ...
    group("test _startOrderProcess", () {
      blocTest<HomeViewModel, HomeStates>(
        ...
        build: () {
          ...
          final startOrderMockResult = SucessResult<StartOrderResponseEntity>(
            responseEntity,
          );
          provideDummy<Result<StartOrderResponseEntity>>(startOrderMockResult);
          when(
            mockUpdateOrderStateUseCase.startOrder(any),
      ...
      blocTest<HomeViewModel, HomeStates>(
        ...
        build: () {
          ...
          final startOrderMockResult = FailedResult<StartOrderResponseEntity>(
            "error",
          );
          provideDummy<Result<StartOrderResponseEntity>>(startOrderMockResult);
          when(
      ...
      blocTest<HomeViewModel, HomeStates>(
        ...
        expect: () => const [
          HomeStates(isLoading: true),
          HomeStates(addedToRemote: true),
          HomeStates(orderStarted: true, addedToRemote: true),
          HomeStates(
            isLoading: false,
