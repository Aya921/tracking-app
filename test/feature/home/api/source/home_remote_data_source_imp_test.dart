...
import 'package:tracking_app/feature/home/api/models/order_response_model.dart';
...
void main() {
  ...
  late List<RemoteOrderModel> fakeRemoteOrder;
  late OrderResponse fakeOrderResponse;
  ...
  setUpAll(() {
    ...
    fakeOrderResponse = OrderResponse(
