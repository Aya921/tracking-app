...
void main() {
  group('RemoteShippingAddressModel', () {
    group('test toEntity function', () {
      test('should return correct ShippingAddressEntity when model is not null', () {
        // arrange
        final model = RemoteShippingAddressModel(
          street: 'El Tahrir',
          city: 'Cairo',
          phone: '01123456789',
          lat: '30.0444',
        ...
        // act
        final entity = RemoteShippingAddressModel.toEntity(model);
      ...
      test('should return default fake address when model is null', () {
        // act
        final entity = RemoteShippingAddressModel.toEntity(null);
    ...
    group('test fromEntity function', () {
      test('should map all fields correctly from entity to model', () {
        ...
        // act
        final model = RemoteShippingAddressModel.fromEntity(entity);
